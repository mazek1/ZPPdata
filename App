...
# Upload skabelon og datafiler
with st.sidebar:
    template_file = st.file_uploader("Upload standardskabelon (Excel)", type=["xlsx"])
...
if template_file and data1 and data2 and data3 and data4:
